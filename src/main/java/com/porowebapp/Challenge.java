...
public class Challenge {
    ...
    public void battle(){
        if(this.user1.equals(this.user2)){
            ...
            this.text="You did not find anyone to challenge, but practicing hard gained 3 exp for your equipment.";
        }else{
            ...
            if(this.curhp1==0){
                ...
                this.command=this.user1+" battle "+this.user2+" lose false";
